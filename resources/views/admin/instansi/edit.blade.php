                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.instansi.update', $instansi->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="npsn" class="block mt-1 w-full" type="text" name="npsn" :value="old('npsn', $instansi->npsn)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="alamat" name="alamat" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('alamat', $instansi->alamat) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="kepala_sekolah" class="block mt-1 w-full" type="text" name="kepala_sekolah" :value="old('kepala_sekolah', $instansi->kepala_sekolah)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="kontak" class="block mt-1 w-full" type="text" name="kontak" :value="old('kontak', $instansi->kontak)" required />
